---
name: reformat-doc
description: Use when the user wants to reformat a messy or wall-of-text document for readability without losing any information, or invokes /reformat-doc. Produces a scannable sibling copy (headers, lists, tables, bolded key terms) with a zero-loss guarantee enforced by a fresh-context audit against a literal-facts inventory.
---
