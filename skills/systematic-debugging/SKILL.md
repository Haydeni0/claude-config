...
Forked from systematic-debugging (plugin claude-plugins-official, v6.3.0) on 2026-09-01; description rewritten to require explicit user request.
...
1. **Create Failing Test Case**
   ...
   - Use the `tdd-core` skill for writing proper failing tests
